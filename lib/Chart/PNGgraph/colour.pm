...
#
#	Name:
#		Chart::PNGgraph::colour.pm
#
#	Description:
#		Package of colour manipulation routines, to be used 
#		with Chart::PNGgraph.
#
# $Id: colour.pm,v 1.1.1.1.2.2 1999/10/07 21:04:01 sbonds Exp $
#
#==========================================================================

 
package Chart::PNGgraph::colour;

use vars qw( @EXPORT_OK %EXPORT_TAGS );
use strict qw( vars refs subs );
require Exporter;

@Chart::PNGgraph::colour::ISA = qw( Exporter );

$Chart::PNGgraph::colour::prog_name    = 'Chart::PNGgraph::colour.pm';
$Chart::PNGgraph::colour::prog_rcs_rev = '$Revision: 1.1.1.1.2.2 $';
$Chart::PNGgraph::colour::prog_version = 
	($Chart::PNGgraph::colour::prog_rcs_rev =~ /\s+(\d*\.\d*)/) ? $1 : "0.0";
...
my %WarnedColours = ();
    ...
    sub version 
	{
        return $Chart::PNGgraph::colour::prog_version;
    }
    ...
    $Chart::PNGgraph::colour::prog_name;
