...
@Chart::PNGgraph::axestype::ISA = qw( Chart::PNGgraph );
...

{
	...
	# inherit check_data from Chart::PNGgraph
...
#				$x -= $s->{xafw} * length($$d[0][$i])/2;
	...
	sub set_max_min($)
	{
		...
		if (ref($s) eq 'Chart::PNGgraph::bars' or ref($s) eq 'Chart::PNGgraph::area')
		{
...
} # End of package Chart::PNGgraph::axestype
