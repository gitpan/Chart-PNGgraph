...
use Chart::PNGgraph;
use Chart::PNGgraph::utils qw(:all);
use Chart::PNGgraph::colour qw(:colours :lists);

@Chart::PNGgraph::pie::ISA = qw( Chart::PNGgraph );
...
my %Defaults = (
	...
	# is being set in Chart::PNGgraph::pie::initialise
...

{
	...
	# inherit checkdata from Chart::PNGgraph
	...
	# inherit open_graph from Chart::PNGgraph
...
} # End of package Chart::PNGgraph::pie
